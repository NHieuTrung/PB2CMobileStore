...
(
	...
	RoleMember nvarchar(120) NOT NULL
)

CREATE TABLE GenderType
(
	GenderTypeId int IDENTITY(1,1) PRIMARY KEY,
	GenderName nvarchar(120) NOT NULL UNIQUE
)
...
(
	...
	MemberGoogleId varchar(200),
	MemberFacebookId varchar(200),
	MemberTypeId int FOREIGN KEY REFERENCES MemberType(MemberTypeId) NOT NULL --0: AD, 1:NV 2:KH--
)

--TABLE ADDRESS--
CREATE TABLE AddressMember
(
	AddressMemberId int IDENTITY(1,1) PRIMARY KEY,
	AddressMemberName nvarchar(200),
	MemberId int FOREIGN KEY REFERENCES Member(MemberId),
	PriorityStatus int default 0
)
...
(
	...
	BrandName nvarchar(20) NOT NULL UNIQUE
)
...
(
	...
	BrandTypeId int FOREIGN KEY REFERENCES BrandType(BrandTypeId) NOT NULL,
...
(
	...
	ProductPortableDeviceId int FOREIGN KEY REFERENCES ProductPortableDevice(ProductPortableDeviceId) NOT NULL,
...
(
	...
	CustomerId int REFERENCES Member(MemberId) NOT NULL,
	OrderDate datetime NOT NULL,
	ShippedDate date,
	EmployeeId int REFERENCES Member(MemberId),
	PromotionId int REFERENCES Promotion(PromotionId),
	PaymentTypeId int REFERENCES PaymentType(PaymentTypeId) not null,
	AddressMemberId int REFERENCES AddressMember(AddressMemberId) not null,
	StatusCart int NOT NULL--0:Chưa thanh toán/1:Đã thanh toán/2:Đang giao hàng/3:Đã huỷ--
)
...
(
	...
	ShoppingCartId int FOREIGN KEY REFERENCES ShoppingCart(ShoppingCartId) NOT NULL,
...
----------------------------INSERT MEMBERTYPE---------------------------------------
INSERT into Member(FullName,MemberEmail,MemberPassword,PhoneNumber,StoreId,GenderTypeId,FileImage,Birthday,RegDate,MemberTypeId)
VALUES (N'Nguyễn Hiếu Trung','nguyenhieutrung@gmail.com','c3b18cd75e6c3f1669f3a2a32ce8f5e2','01686501020',1,1,'nguyenhieutrung.png','1997-07-07','2018-07-20',1),

	   (N'Nguyễn Ánh','nguyenanh@gmail.com','bb602d34f5634a1322c5fb5e9465a3db','098756478',1,2,'nguyenanh.png','1997-6-6','2018-2-7',2),
	   (N'Châu Tuyết','chautuyet@gmail.com','d3a7d49ee31def9d72a482ccdc3890b8','012547896',1,2,'chautuyet.png','1995-5-5','2018-2-7',2),

	   (N'Châu Khoa','chaukhoa@gmail.com','d3a7d49ee31def9d72a482ccdc3890b8','0245789545',1,1,'chautuyet.png','1994-5-15','2018-2-7',2),
	   (N'Nguyễn Thùy','nguyenthuy@gmail.com','5a6a358db34b11ca7b1c0ea4697b9a1f','01456987',1,2,'nguyenthuy.png','1995-2-15','2018-2-7',2)


	   ----------------------------INSERT ADRESSMEMBER---------------------------------------
INSERT into AddressMember(AddressMemberName,MemberId)
VALUES (N'1300 Phạm Thế Hiển P5 Q8',1),
		(N'130 An Dương Vương P6 Q5',2),
		(N'23 Hồng Bàng P5 Q5',3),
		(N'23 Hồng Bàng P5 Q5',4),
		(N'25 Hồng Bàng P5 Q5',5)
...
VALUES('Iphone X',1,'/Assets/user/images/1.jpg','2017-11-03',1),
	  ('Iphone 8',1,'/Assets/user/images/2.jpg','2017-09-15',1),
	  ('Iphone 8 Plus',1,'/Assets/user/images/3.jpg','2017-09-15',1)
--Samsung--
INSERT into Product(ProductName,BrandTypeId,FileImage,RealeaseDate,ProductTypeId)
VALUES('Galaxy S8',2,'/Assets/user/images/4.jpg','2017-04-04',1),
	  ('Galaxy S8 Plus',2,'/Assets/user/images/5.jpg','2017-04-04',1),
	  ('Galaxy S9',2,'/Assets/user/images/6.jpg','2018-03-16',1),
	  ('Galaxy S9 Plus',2,'/Assets/user/images/7.jpg','2018-03-16',1),
	  ('Galaxy Note 8',2,'/Assets/user/images/8.jpg','2018-09-15',1)
--Sony--
INSERT into Product(ProductName,BrandTypeId,FileImage,RealeaseDate,ProductTypeId)
VALUES('Xperia XZ1',3,'/Assets/user/images/9.jpg','2017-09-19',1),
	  ('Xperia XZ2',3,'/Assets/user/images/10.jpg','2018-04-01',1),
	  ('Xperia XA2',3,'/Assets/user/images/11.jpg','2018-02-01',1),
	  ('Xperia XZS',3,'/Assets/user/images/12.jpg','2017-05-22',1),
	  ('Xperia XZ Premium',3,'/Assets/user/images/13.jpg','2017-04-01',1)
...
INSERT into ProductPortableDevice(ProductId, Color, MemorySize, RamSize, Display, Price, FileImage, Quantiny)
VALUES(11,'Black', 32, 3, N'5.2 inch', 6590000, 'snxa2_black.png', 5),
	  (11,'Silver', 32, 3, N'5.2 inch', 6590000, 'snxa2_silver.png', 7),
	  (11,'Blue', 32, 3, N'5.2 inch', 6590000, 'snxa2_blue.png', 6),
	  (11,'Pink', 32, 3, N'5.2 inch', 6590000, 'snxa2_pink.png', 5)
...
INSERT into ProductPortableDevice(ProductId, Color, MemorySize, RamSize, Display, Price, FileImage, Quantiny)
VALUES(13,'Black', 64, 4, N'5.5 inch', 15990000, 'snxzpre_black.png', 9),
	  (13,'Pink', 64, 4, N'5.5 inch', 15990000, 'snxzpre_pink.png', 2),
	  (13,'Red', 64, 4, N'5.5 inch', 15990000, 'snxzpre_red.png', 1),
	  (13,'Chrome', 64, 4, N'5.5 inch', 15990000, 'snxzpre_chrome.png', 6)
...
INSERT into Product(ProductName,ProductTypeId,FileImage,BrandTypeId,RealeaseDate)
	VALUES('Tai nghe Mono Bluetooth',2,'/Assets/user/images/14.jpg',2,'2014/11/02'),
		  ('Tai nghe có dây EG920',2,'/Assets/user/images/15.jpg',2,'2015/11/04'),
		  ('Tai nghe có dây IG935',2,'/Assets/user/images/16.jpg',2,'2016/05/01'),
		  ('Tai nghe Level U Pro',2,'/Assets/user/images/17.jpg',2,'2016/09/01'),
		  ('Tai nghe AKG S8',2,'/Assets/user/images/18.jpg',2,'2017/04/28'),
		  ('Loa Bluetooth Scoop',2,'/Assets/user/images/19.jpg',2,'2016/09/21'),
		  ('Loa Bluetooth Bottle',2,'/Assets/user/images/20.jpg',2,'2017/01/01')

--Sony--
INSERT into Product(ProductName,ProductTypeId,FileImage,BrandTypeId,RealeaseDate)
	VALUES('Tai nghe bluetooth SBH90C',2,'/Assets/user/images/21.jpg',3,'2018/03/02'),
		  ('Tai nghe bluetooth MBH22',2,'/Assets/user/images/22.jpg',3,'2018/01/24'),
		  ('Sony Xperia Touch',2,'/Assets/user/images/23.jpg',3,'2017/10/25')
...
delete from Member where Member.MemberId=7;